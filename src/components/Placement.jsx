    ...
    <div className="flex justify-center items center">
      <div className="w-[60%]">
            ...
            {programs.map((item, index) => {
              return (
                ...
                <div className="border  rounded-md p-3 bg-white hover:translate-x-[-10px] hover:translate-y-[-10px] transtion duration-300 border-black w-[300px]  h-[533px]">
                   ...
                   <h2 className="pb-3 mt-4 text-xl font-semibold  border-b">{item.degree}</h2>
                   ...
                   <div className="mt-4">
                    {
                      item.reasons.map((itemm,index)=>{
                        return (
                          <div key={index} className="flex items-center mt-3 text-[12px] gap-3">
                            <div>
                              <FaAngleRight />
                            </div>
                            <p>{itemm}</p>
        ...
        <div className="flex justify-end items center mt-6 me-10">
            <div onClick={leftt} className="text-2xl hover:cursor-pointer"><FaAngleLeft /></div>
            <div onClick={rightt} className="text-2xl ms-4 hover:cursor-pointer"><FaAngleRight /></div>
        </div>
      </div>
    </div>
  );
